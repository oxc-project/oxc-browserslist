...
pub static ELECTRON_VERSIONS: &[(ElectronVersion, &str)] = &[
    ...
    (ElectronVersion::new(35u16, 7u16), "134"),
    ...
    (ElectronVersion::new(36u16, 7u16), "136"),
    (ElectronVersion::new(36u16, 8u16), "136"),
    (ElectronVersion::new(36u16, 9u16), "136"),
    (ElectronVersion::new(37u16, 0u16), "138"),
    (ElectronVersion::new(37u16, 1u16), "138"),
    (ElectronVersion::new(37u16, 2u16), "138"),
    (ElectronVersion::new(37u16, 3u16), "138"),
    (ElectronVersion::new(37u16, 4u16), "138"),
    (ElectronVersion::new(37u16, 5u16), "138"),
    (ElectronVersion::new(37u16, 6u16), "138"),
    (ElectronVersion::new(37u16, 7u16), "138"),
    (ElectronVersion::new(37u16, 8u16), "138"),
    (ElectronVersion::new(37u16, 9u16), "138"),
    (ElectronVersion::new(37u16, 10u16), "138"),
    (ElectronVersion::new(38u16, 0u16), "140"),
    (ElectronVersion::new(38u16, 1u16), "140"),
    (ElectronVersion::new(38u16, 2u16), "140"),
    (ElectronVersion::new(38u16, 3u16), "140"),
    (ElectronVersion::new(38u16, 4u16), "140"),
    (ElectronVersion::new(38u16, 5u16), "140"),
    (ElectronVersion::new(38u16, 6u16), "140"),
    (ElectronVersion::new(38u16, 7u16), "140"),
    (ElectronVersion::new(38u16, 8u16), "140"),
    (ElectronVersion::new(39u16, 0u16), "142"),
    (ElectronVersion::new(39u16, 1u16), "142"),
    (ElectronVersion::new(39u16, 2u16), "142"),
    (ElectronVersion::new(39u16, 3u16), "142"),
    (ElectronVersion::new(39u16, 4u16), "142"),
    (ElectronVersion::new(39u16, 5u16), "142"),
    (ElectronVersion::new(39u16, 6u16), "142"),
    (ElectronVersion::new(39u16, 7u16), "142"),
    (ElectronVersion::new(39u16, 8u16), "142"),
    (ElectronVersion::new(40u16, 0u16), "144"),
    (ElectronVersion::new(40u16, 1u16), "144"),
    (ElectronVersion::new(40u16, 2u16), "144"),
    (ElectronVersion::new(40u16, 3u16), "144"),
    (ElectronVersion::new(40u16, 4u16), "144"),
    (ElectronVersion::new(40u16, 5u16), "144"),
    (ElectronVersion::new(40u16, 6u16), "144"),
    (ElectronVersion::new(40u16, 7u16), "144"),
    (ElectronVersion::new(40u16, 8u16), "144"),
    (ElectronVersion::new(40u16, 9u16), "144"),
    (ElectronVersion::new(40u16, 10u16), "144"),
    (ElectronVersion::new(41u16, 0u16), "146"),
    (ElectronVersion::new(41u16, 1u16), "146"),
    (ElectronVersion::new(41u16, 2u16), "146"),
    (ElectronVersion::new(41u16, 3u16), "146"),
    (ElectronVersion::new(41u16, 4u16), "146"),
    (ElectronVersion::new(41u16, 5u16), "146"),
    (ElectronVersion::new(41u16, 6u16), "146"),
    (ElectronVersion::new(41u16, 7u16), "146"),
    (ElectronVersion::new(42u16, 0u16), "148"),
    (ElectronVersion::new(42u16, 1u16), "148"),
    (ElectronVersion::new(42u16, 2u16), "148"),
    (ElectronVersion::new(42u16, 3u16), "148"),
    (ElectronVersion::new(43u16, 0u16), "150"),
];
